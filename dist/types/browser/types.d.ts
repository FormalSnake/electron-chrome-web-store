...
export type BeforeInstall = (details: ExtensionInstallDetails) => Promise<{
    action: 'allow' | 'deny';
}>;
export type AfterInstall = (details: {
    id: string;
    manifest: chrome.runtime.Manifest;
}) => void;
...
export type CustomSetExtensionEnabled = (state: WebStoreState, extensionId: string, enabled: boolean) => Promise<boolean>;
export type OverrideExtensionInstallStatus = (state: WebStoreState, extensionId: string, manifest?: chrome.runtime.Manifest) => string | undefined;
